...
Casting Spells
{max number of wishes a mage can absorb: 
Strongwilled-Vunderable value*(-100), if value is positive, he cannot use magic}
{spell preperation time: equal to number of wishes * 10. Rationale is that a magician needs about 1" to 2" for every 100 wishes. Execution time determined by spell}
<li>
*Attack spells
*Defence spells
